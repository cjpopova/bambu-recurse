proc dump_statistics {  } {
  ...
  file delete -force HLS_output/Synthesis/vivado_flow_0/_Z7man_fibj_report.xml 
  set ofile_report [open HLS_output/Synthesis/vivado_flow_0/_Z7man_fibj_report.xml w]
...
set outputDir HLS_output/Synthesis/vivado_flow_0
file mkdir $outputDir
create_project _Z7man_fibj -part xc7z020clg484-1 -force
read_verilog man_fib.v
set rfile_sdc [open HLS_output/Synthesis/vivado_flow_0/_Z7man_fibj.sdc r]
set clk_constraint [regexp -all --  CLK_SRC [read $rfile_sdc [file size HLS_output/Synthesis/vivado_flow_0/_Z7man_fibj.sdc]]]
if { [expr {$clk_constraint == 0}] } {
  set ofile_sdc [open HLS_output/Synthesis/vivado_flow_0/_Z7man_fibj.sdc a]
  puts $ofile_sdc "set_property HD.CLK_SRC BUFGCTRL_X0Y0 \[get_ports clock\]"
  close $ofile_sdc
}
read_xdc HLS_output/Synthesis/vivado_flow_0/_Z7man_fibj.sdc
synth_design -mode out_of_context -no_iobuf -top _Z7man_fibj -part xc7z020clg484-1
